...
export const engineeringLogs = [
  {
    ...
    summary: 'RollingUpdate strategy with health-gated traffic routing for continuous availability.',
  ...
  },
  {
    ...
    summary: 'Authenticated encryption with TDD validation for fintech document security.',
  ...
  },
  {
    ...
    summary: 'Node.js indexer for Solidity events with MongoDB aggregation layer.',
  ...
  },
  {
    ...
    summary: 'Hybrid rendering architecture with strict type enforcement for large codebases.',
  ...
  },
  {
    ...
    summary: 'Error handling, monitoring, and deployment strategies for MERN applications.',
    linkedCaseStudy: 'codecommons',
