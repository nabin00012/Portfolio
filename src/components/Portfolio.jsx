    ...
    <div className="portfolio-wrapper">
      ...
      >
        <div className="hero-content">
          ...
          {/* Creative Rotating Roles & Code Preview (visual only) */}
          <div className="hero-enhancements">
            ...
            <div className="floating-code-preview" aria-hidden>
              <div className="code-header">
                ...
                <span className="file-name">realchat/server.js</span>
              </div>
              <pre className="code-snippet">{`// Real-time socket handler
io.on('connection', socket => {
  socket.on('msg', async (data) => {
    await saveMessage(data);
    io.emit('msg', sanitize(data));
  });
});
`}</pre>
            </div>
